...
import 'import_wallet_cubit.dart';
                            ...
                            child: _isShowingTextField
                                ? TextField(
                                    ...
                                    decoration: InputDecoration(
                                        ...
                                        fillColor: const Color(0xff494B4C),
                                        filled: true),
                                    onChanged: (value) {
                      ...
                      Row(
                        children: [
                          ...
                          Padding(
                            ...
                            child: GreenButton(
                                isBorder: state.recoveryWords.length != 12
                                    ? true
                                    : false,
                                isActive: state.recoveryWords.length == 12
                                    ? true
                                    : false,
                                onTap: () async {
